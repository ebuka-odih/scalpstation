...
<head>
    ...
    <title>Dashboard | Prepstation</title>
    ...
    <header class="main-header">
        <div class="d-flex align-items-center logo-box pl-20">
            ...
            <a href="{{ route('index') }}" class="logo">
                <!-- logo-->
                <div class="logo-lg">
                    <h3 class="mt-3" style="font-weight: bolder; color: #1288c9 !important">PrepStation</h3>
...
{{--                        </li>--}}
   ...
   @yield('content')
    ...
    <footer class="main-footer">
        ...
        &copy; 2020 <a href="https://www.prepstation.co/">PrepStation</a>. All Rights Reserved.
    </footer>
