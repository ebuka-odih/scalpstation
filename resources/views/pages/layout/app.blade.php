...
{{--            <img src="logo3.png" alt="" style="height:45px;background-color:white;border-radius:20px"  class="img-fluid">--}}
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav pc_navbar_nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="portfolio/login.html">LOG IN</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="portfolio/register.html">SIGN UP</a>
                </li>
                <li class="nav-item">
...
<div class="container px-0 my-0 mt-2 d-lg-none d-sm-block">
    <nav class="navbar mobile_nav navbar-expand-lg navbar-dark">
        <a href="{{ route('index') }}" class="nav-brand">
            <h3 style="color:white; font-weight: bolder">Scalpstation</h3>
{{--            <img src="logo3.png" alt="" style="height:45px;background-color:white;border-radius:20px" class="img-fluid">--}}
        </a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav"
                aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
...
<nav>
    <div class="container">
        <nav class="navbar navbar-expand-lg">
          <a class="navbar-brand" href="../finnexia/"><div class="logo-brand"><img src="img/master/logo-2.png" alt=""></div></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="?a=plans">INVESTMENTS</a>
              </li>

              <li class="nav-item">
                <a class="nav-link" href="?a=faq">QUESTION GUIDE</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="?a=plans">REGIONAL REPRESENTATIVE</a>
              </li>
                                <li class="nav-item">
                <a class="nav-link" href="?a=login">LOG IN</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="?a=signup">SIGN UP</a>
              </li>
                                <li class="nav-item">
                <a class="nav-link" href="?a=support">CONTACT</a>
              </li>
            </ul>
          </div>
        </nav>
