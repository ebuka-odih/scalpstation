...
Route::group(['middleware' => ['auth', 'verified', 'admin'], 'prefix' => 'admin', 'as' => 'admin.'], function(){
    ...
    Route::post('edit/balance', "Admin\AdminController@editBalance")->name('editBalance');
    Route::post('edit/profit', "Admin\AdminController@editProfit")->name('editProfit');
    ...
    Route::get('trade/details/{id}', "Admin\AdminTradesController@tradeDetails")->name('tradeDetails');
    ...
    Route::get('subscribers', "Admin\AdminSubscribers@subscribers")->name('subscribers');
    Route::get('approve/subscribers/{id}', "Admin\AdminSubscribers@approve_subscribers")->name('approve_subscribers');
    Route::delete('delete/subscribers/{id}', "Admin\AdminSubscribers@deleteSubscribers")->name('deleteSubscribers');

    Route::resource('balance', "Admin\AdminBalanceController");
    Route::get('create/balance/{id}', "Admin\AdminBalanceController@createBalance")->name('createBalance');
});
