...
class UserController extends Controller
{
    public function dashboard()
    {
        ...
        $subscribe = Subscribe::whereUserId(\auth()->id())->where('status', 1)->sum('amount');
        ...
        return view('dashboard.index', compact('trade', 'deposits', 'withdrawal', 'subscribe', 'bonus', 'bonus2'));
    }

    public function portfolio()
    {
        $balance = Balance::whereUserId(\auth()->id())->get();
        return view('dashboard.user.balance', compact('balance'));
    }
