            ...
            _createClass(Iti, [ {
                ...
                value: function _updateFlagFromNumber(originalNumber) {
                    ...
                    if (countryCode !== null) { 
                        ...
                        var newCountryData = this._getCountryData(countryCode, false, false);
                        var currentCountryData = this.selectedCountryData;

                        if (newCountryData.dialCode == currentCountryData.dialCode)
                            return false;
